...
- [`communication/paper_ii/`](communication/paper_ii/) — reproducible DUNE TDR source-to-count benchmark, few-event decoder simulations, figures, tests, and article/proposal drafts for *End-to-End Simulation of a Neutrino Communication Channel Through the Earth*.
...
The Paper II output uses the public DUNE TDR FHC far-detector flux and explicitly documents the efficiency proxy, exposure approximation, and background scenarios. It does not claim a spill-level or operational communication link.
